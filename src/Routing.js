...
class Routing extends React.Component {
  ...
  render() {
    ...
    return(
      <Body>
        <NavLink to="/newpost"><AddFormIcon/>Addpost</NavLink>
      ...
      <Switch>
        ...
        <Route path="*" render={() => {
          ...
          return(
            <div>
              I wish I could help you body, but really, what is the point of looking around different links in this website? Anyways enjoy the rest of your day.
              404: page not found
            </div>
          )
        }}
